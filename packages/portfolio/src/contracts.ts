...
/** Exact source quantity, either legacy numeric data or raw base-unit text. */
export type PortfolioQuantity = number | string;
...
export interface PortfolioSource {
  ...
  /** Stable source record retained only when explicitly supplied by an upstream source. */
  readonly externalRecordId?: string;
  /** Network scope retained for source provenance when explicitly observed. */
  readonly networkId?: PortfolioNetworkId;
  /** Source-supplied locator, such as a wallet address; never generated by this domain. */
  readonly externalLocator?: string;
}
...
export interface PortfolioAsset {
  ...
  /** Source-supplied representation precision retained without quantity conversion. */
